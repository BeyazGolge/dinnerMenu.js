...
showList("All");
menu.forEach((item)=>{categories.push(item.category)});
...
categories.forEach((item)=>{
  ...
  button.setAttribute("onClick","showList(this.id)");
...
function showList(category)
{
  ...
  if(category !== "All")
  {
    filteredMenu = menu.filter((item)=>{return item.category == category});
  }
